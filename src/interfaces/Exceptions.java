...
public class Exceptions extends JDialog {
	...
	public Exceptions(String errorLabelText, String errorDescription,
			Throwable e) {
	...
	public Exceptions(String EroTxt, Throwable e) {
		this(EroTxt, null, e);
	}
	...
	private void setListners() {
		...
		okButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				Exceptions.this.setVisible(false);
			}
		});
		...
		viewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (open) {
					...
					Exceptions.this.setSize(dialogWidth, dialogHeight);
					...
					Exceptions.this.setSize(dialogWidth,
							dialogHeight + 100);
