...
public class process extends javax.swing.JFrame
{
    ...
    public process(String encryptOrDecrypt)
    {
        ...
        addWindowListener( new WindowAdapter()
        {
            public void windowClosing(WindowEvent e)
            {
                ...
                if(completedTask)
                {
                    ...
                    result = JOptionPane.showConfirmDialog(frame, "Are you sure you want to exit ?", "Exit Application", JOptionPane.YES_NO_OPTION);
                ...
                {
                    Toolkit.getDefaultToolkit().beep();
                    result = JOptionPane.showConfirmDialog(frame, "Encryption is in progress. "+"Are you sure you want to exit?", "Exit Application", JOptionPane.YES_NO_OPTION);
                    if (result == JOptionPane.YES_OPTION)
                    frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                }
                ...
                {
                    Toolkit.getDefaultToolkit().beep();
                     result = JOptionPane.showConfirmDialog(frame, "Decryption is in progress. "+"Are you sure you want to exit?", "Exit Application", JOptionPane.YES_NO_OPTION);
                     if (result == JOptionPane.YES_OPTION)
                     frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                }
